...
function(e, t) {
    ...
    var I, L, O, _ = function() {
        function e(t, i) { (function(e, t) {
            ...
            E(this.element) && M(this.element.rangeTouch) && (this.config = p({},
            f, {},
            i), this.init())
        }
        ...
        },
        {
            key: "set",
            value: function(t) {
                e.enabled && N(t) && !t.target.disabled && (t.preventDefault(), t.target.value = this.get(t),
                function(e, t) {
                    if (e && t) {
                        var i = new Event(t, {
                            bubbles: !0
    ...
    function ce() {
        ...
        t = arguments.length, i = new Array(t > 1 ? t - 1 : 0), a = 1; a < t; a++) i[a - 1] = arguments[a];
        if (!i.length) return e;
        var s = i.shift();
        return z(s) ? (Object.keys(s).forEach((function(t) {
            z(s[t]) ? (Object.keys(e).includes(t) || Object.assign(e, n({},
            t, {})), ce(e[t], s[t])) : Object.assign(e, n({},
            t, s[t]))
    ...
    function fe(e) {
        if (G(e)) for (var t = e.childNodes.length; t > 0;) e.removeChild(e.lastChild),
        t -= 1
    }
    function ge(e, t) {
    ...
    function Le(e) {
        ...
        r = function r() {
            ...
            l = new Array(o), c = 0; c < o; c++) l[c] = arguments[c];
            n.apply(t, l)
        };
    ...
    function Ue(e) {
        ...
        i = new Array(t > 1 ? t - 1 : 0), n = 1; n < t; n++) i[n - 1] = arguments[n];
    ...
    var nt = {
        ...
        createButton: function(e, t) {
            ...
            de(r, n),
            "play" === a ? ($(this.elements.buttons[a]) || (this.elements.buttons[a] = []), this.elements.buttons[a].push(r)) : this.elements.buttons[a] = r,
            r
        },
        ...
        durationUpdate: function() {
            if (this.supported.ui && (this.config.invertTime || !this.currentTime)) {
                if (this.duration >= Math.pow(2, 32)) return ve(this.elements.display.currentTime, !0),
                ...
                var e = G(this.elements.display.duration); ! e && this.config.displayDuration && this.paused && nt.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
        ...
        updateSetting: function(e, t, i) {
            ...
            if ("captions" === e) a = this.currentTrack;
                ...
                if (a = ae(i) ? this[e] : i, ae(a) && (a = this.config[e].
            default), !ae(this.options[e]) && !this.options[e].includes(a)) return void this.debug.warn("Unsupported value of '".concat(a, "' for ").concat(e));
        ...
        create: function(e) {
            ...
            return Be($(this.config.controls) ? this.config.controls: []).forEach((function(o) {
                ...
                if ("current-time" === o && u.appendChild(r.call(t, "currentTime", d)), "duration" === o && u.appendChild(r.call(t, "duration", d)), "mute" === o || "volume" === o) {
                    ...
                    if (G(p) && u.contains(p) || (p = he("div", ce({},
                    d, {
                ...
                if ("pip" === o && Ee.pip && u.appendChild(n.call(t, "pip", d)), "airplay" === o && Ee.airplay && u.appendChild(n.call(t, "airplay", d)), "download" === o) {
                    ...
                    var T = t.config.urls.download; ! ne(T) && t.isEmbed && ce(k, {
    ...
    var rt = {
        setup: function() {
            if (this.supported.ui) if (!this.isVideo || this.isYouTube || this.isHTML5 && !Ee.textTracks) $(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && nt.setCaptionsMenu.call(this);
            else {
        ...
        findTrack: function(e) {
            ...
            s = function(e) {
                return Number((i.captions.meta.get(e) || {}).
            default)
            },
    ...
    lt = "picture-in-picture", ct = "inline", ut = {
        html5: "html5",
        youtube: "youtube",
        vimeo: "vimeo"
    },
    ...
    pt = function() {
        ...
        function t(i) {
            ...
            this.player.elements.fullscreen = i.config.fullscreen.container &&
            function(e, t) {
        ...
        },
        {
            key: "exit",
            value: function() {
                if (this.enabled) if (oe.isIos && this.player.config.fullscreen.iosNative) this.target.webkitExitFullscreen(),
                De(this.player.play());
    ...
    var yt = {
        ...
        build: function() {
            ...
            this.poster && yt.setPoster.call(this, this.poster, !1).
            catch((function() {})),
        ...
        migrateStyles: function() {
            var e = this;
            Object.values(s({},
            this.media.style)).filter((function(e) {
    ...
    vt = function() {
        ...
        },
        {
            ...
            value: function(e) {
                ...
                if (clearTimeout(this.focusTimer), "keydown" !== e.type || 9 === e.which) {
                    ...
                    if ("focus" !== e.type || a) n = t.config.classNames.tabFocus,
        ...
        },
        {
            ...
            value: function() {
                ...
                t = e.config,
                i = e.elements,
                n = e.timers; ! t.keyboard.global && t.keyboard.focused && xe.call(e, i.container, "keydown keyup", this.handleKey, !1),
                xe.call(e, i.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", (function(t) {
                    ...
                    var s = 0; ["touchstart", "touchmove", "mousemove"].includes(t.type) && (yt.toggleControls.call(e, !0), s = e.touch ? 3e3: 2e3),
        ...
        },
        {
            ...
            value: function() {
                ...
                if (xe.call(t, t.media, "timeupdate seeking seeked", (function(e) {
                    ...
                    if (!G(n)) return;
                    xe.call(t, i.container, "click", (function(a) { ([i.container, n].includes(a.target) || n.contains(a.target)) && (t.touch && t.config.hideControls || (t.ended ? (e.proxy(a, t.restart, "restart"), e.proxy(a, (function() {
                            De(t.play())
        ...
        },
        {
            ...
            value: function() {
                ...
                if (i.buttons.play && Array.from(i.buttons.play).forEach((function(i) {
                    ...
                    var i = e.which; [13, 32].includes(i) && (13 !== i ? (e.preventDefault(), e.stopPropagation(), nt.toggleMenu.call(t, e)) : nt.focusFirstMenuItem.call(t, null, !0))
                ...
                this.bind(i.inputs.volume, "wheel", (function(e) {
                    ...
                    var l = t.media.volume; (1 === r && l < 1 || -1 === r && l > 0) && e.preventDefault()
                }), "volume", !1)
            }
        }]),
        t
    ...
    var bt = function(e, t) {
        ...
        e.exports = function() {
            ...
            function s(e, t) {
                if (e) {
                    var a = n[e];
                    if (i[e] = t, a) for (; a.length;) a[0](e, t),
                    a.splice(0, 1)
                }
            }
            function r(t, i) {
            ...
            function o(t, i, n, a) {
                ...
                m = t.replace(/^(css|img)!/, "");
                a = a || 0,
                /(^css!|\.css$)/.test(h) ? ((r = l.createElement("link")).rel = "stylesheet", r.href = m, (s = "hideFocus" in r) && r.relList && (s = 0, r.rel = "preload", r.as = "style")) : /(^img!|\.(png|gif|jpg|svg|webp)$)/.test(h) ? (r = l.createElement("img")).src = m: ((r = l.createElement("script")).src = t, r.async = void 0 === c || c),
    ...
    var Tt = {
        ...
        ready: function() {
            ...
            if (m.setAttribute("src", p), m.setAttribute("allowfullscreen", ""), m.setAttribute("allow", "autoplay,fullscreen,picture-in-picture"), ae(a) || m.setAttribute("referrerPolicy", a), n || !i.customControls) m.setAttribute("data-poster", t.poster),
            ...
            i.customControls || Je(Ue(t.config.urls.vimeo.api, p)).then((function(e) { ! ae(e) && e.thumbnail_url && yt.setPoster.call(t, e.thumbnail_url).
                catch((function() {}))
            })),
            ...
            t.embed.on("loaded", (function() { (t.embed.getPaused().then((function(e) {
                    kt.call(t, !e),
                ...
                e.embed = new window.YT.Player(e.media, {
                    ...
                    events: {
                        ...
                        onStateChange: function(i) {
                            ...
                            case - 1 : Oe.call(e, e.media, "timeupdate"),
                                e.media.buffered = n.getVideoLoadedFraction(),
                                Oe.call(e, e.media, "progress");
                                break;
                            case 0:
                                Ct.call(e, !1),
                                e.media.loop ? (n.stopVideo(), n.playVideo()) : Oe.call(e, e.media, "ended");
                                break;
                            case 1:
    ...
    Et = function() {
        ...
        },
        {
            ...
            value: function() {
                var e = this,
                t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
                if (!t) return clearInterval(this.countdownTimer),
        ...
        },
        {
            ...
            value: function(e) {
                for (var t = this,
                i = arguments.length,
                n = new Array(i > 1 ? i - 1 : 0), a = 1; a < i; a++) n[a - 1] = arguments[a];
                var s = this.events[e];
        ...
        var i = {};
        return e > t.width / t.height ? (i.width = t.width, i.height = 1 / e * t.width) : (i.height = t.height, i.width = e * t.height),
        i
    },
    Mt = function() {
        function t(i) {
        ...
        {
            key: "startScrubbing",
            value: function(e) { (W(e.button) || !1 === e.button || 0 === e.button) && (this.mouseDown = !0, this.player.media.duration && (this.toggleScrubbingContainer(!0), this.toggleThumbContainer(!1, !0), this.showImageAtCurrentTime()))
            }
        },
        {
            key: "endScrubbing",
        ...
        },
        {
            ...
            value: function() {
                ...
                this.elements.thumb.time = he("span", {},
                "00:00"),
        ...
        },
        {
            ...
            value: function() {
                ...
                r = n.frames[i].text,
                o = a + r;
                if (this.currentImageElement && this.currentImageElement.dataset.filename === r) this.showImage(this.currentImageElement, s, t, i, r, !1),
        ...
        },
        {
            ...
            value: function() { (this.elements.thumb.imageContainer.clientHeight > 20 || this.elements.thumb.imageContainer.clientWidth > 20) && (this.sizeSpecifiedInCSS = !0)
            }
        },
        {
    ...
    var It, Lt = function() {
        function t(i, n) {
            ...
            this.ready = !1, this.loading = !1, this.failed = !1, this.touch = Ee.touch, this.media = i, Y(this.media) && (this.media = document.querySelectorAll(this.media)), (window.jQuery && this.media instanceof jQuery || J(this.media) || $(this.media)) && (this.media = this.media[0]), this.config = ce({},
            ot, t.defaults, n || {},
            function() {
                try {
            ...
            this.debug = new pt(this.config.debug), this.debug.log("Config", this.config), this.debug.log("Support", Ee), !W(this.media) && G(this.media)) if (this.media.plyr) this.debug.warn("Target already setup");
            else if (this.config.enabled) if (Ee.check().api) {
        ...
        },
        {
            ...
            set: function(e) {
                ...
                if (i.length) {
                    var n = [!ae(e) && Number(e), this.storage.get("quality"), t.selected, t.
                default].find(K),
                    a = !0;
                    if (!i.includes(n)) {
                        var s = function(e, t) {
        ...
        },
        {
            key: "poster",
            set: function(e) {
                this.isVideo ? yt.setPoster.call(this, e, !1).
